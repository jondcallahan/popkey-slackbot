...
// get route if someone stumbles upon app page
 app.get('/', function (req, res) { res.status(200).send('<body style="background-color:azure; font-family: Helvetica; display: flex; align-content: center; justify-content: center;"><h2><hr style="border-color: tomato; width: 80%"><center>To use the popkey slack integration, add an outgoing webhook with the URL:<br /><br />https://' + req.get('host') + '/</center><hr style="border-color: tomato; width: 80%"></h2></body>'); });
